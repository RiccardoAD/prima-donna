...
import logo from '../assets/images/header-logo1.png'; // aggiorna il path se necessario

const ForMenWomenSection = () => {
  return (
    <section>
      <div className="row">
        {/* Colonna: For Men */}
        ...
        {/* Colonna centrale: Info/logo */}
        <div className="col-md-3 align-items-stretch services-bg">
          <div className="container text-center py-5 mt-5">
            <img src={logo} className="logo-col" alt="Salon Logo" />
            <p style={{ fontSize: '19px' }}>
              <b>Welcome To Saloon</b>
            </p>
            <hr className="bg-tranparent" />
        ...
        <div className="col-md for-women align-items-stretch">
          <div className="p-5 m-5 box-all">
            <div className="container py-5 mt-5 box-inside">
              <h3 className="text-center text-white">For WOMen</h3>
              <a href="#" className="pricing-men">
                <h5>See Pricing</h5>
              </a>
            </div>
...
export default ForMenWomenSection;